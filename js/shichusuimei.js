...
var KSK={
  "甲":{t:["リーダー気質","向上心","正直"],d:"甲の人は大樹のようにまっすぐ上へと伸びていく力を持っています。強い向上心と正義感があり、周囲を引っ張るリーダーとして輝ける素質があります。曲がったことが嫌いで、一度決めたことを最後まで貫き通す芯の強さが人としての魅力です。困難な状況でも諦めずに前を向く姿が、多くの人から尊敬と信頼を集めるでしょう。自分の信念を大切にしながら、周囲への配慮も忘れないことが人生を豊かにする鍵となります。何事にも真摯に取り組む姿勢と、高い目標を掲げ続ける向上心があなたの最大の武器です。"},
  "乙":{t:["柔軟性","協調性","粘り強さ"],d:"乙の人は草花のように柔軟にしなやかに生きる力を持っています。どんな環境にも適応できる柔軟性と、周囲との調和を大切にする協調性が最大の強みです。表面は穏やかでも内側には強い粘り強さを秘めており、一見控えめに見えても実はどんな困難も乗り越えていく底力を持っています。人の感情を敏感に察する共感力の高さが、多くの人から愛される理由です。柔軟に状況に対応しながらも自分の軸をしっかり持ち続けることで、長期的に大きな成果を手にすることができます。あなたの穏やかな存在感が、周囲に安らぎと調和をもたらします。"},
  "丙":{t:["明るさ","情熱","社交性"],d:"丙の人は太陽のように周囲を明るく照らす存在です。生まれながらの社交性と情熱で人を惹きつけ、その場を活気づける天性の才能を持っています。正直でオープンな性格が多くの人から愛される理由であり、どんな場所でも自然と中心的な存在になります。情熱的に物事に取り組む姿勢が周囲に活力を与え、一緒にいるだけで元気をもらえると感じさせる稀有な人物です。ネガティブな状況でも前向きさを失わない精神的な強さが、人生のあらゆる局面で大きな力となります。あなたの明るさと温かさが、周囲の人々の心に光をもたらします。"},
  "丁":{t:["繊細","直感力","芸術性"],d:"丁の人はローソクの炎のように温かく繊細な感受性を持っています。直感力が鋭く、他の人が気づかない物事の本質を瞬時に見抜く洞察力に優れています。芸術的な才能に恵まれており、美しいものへの感受性が高く、創造的な分野で卓越した能力を発揮します。人の心の痛みに寄り添う深い共感力で、困っている人の心をそっと照らす存在です。繊細であるがゆえに傷つきやすい面もありますが、その感受性こそがあなたの最大の才能です。内側に秘めた豊かな感情と創造力が、唯一無二の表現力として花開いていくでしょう。"},
  "戊":{t:["包容力","安定感","誠実"],d:"戊の人は大山のようにどっしりと構えた安定感と包容力を持っています。誠実で信頼できる性格が周囲から慕われ、困ったときに真っ先に頼りにされる存在です。変化よりも着実な積み重ねを好み、長期的な視点で物事を進める力があります。広い心で人を受け入れる包容力は、周囲の人たちに安心感と安らぎを与え、自然と人が集まってくる大きな魅力となっています。どんな状況でも揺るがない精神的な安定感が、周囲を支える大きな柱となっています。あなたの誠実さと包容力が、長年にわたる信頼と絆を育んでいきます。"},
  "己":{t:["現実的","細やか","努力家"],d:"己の人は豊かな大地のように周囲を育て支える力を持っています。現実的な判断力と細やかな気配りができ、コツコツと努力を積み重ねることで確かな結果を出し続けます。縁の下の力持ちとして組織を支える才能があり、地道な積み重ねが最終的に大きな成果につながります。人の細かな変化に気づける観察眼と、そっと手を差し伸べる優しさが周囲から厚く信頼される理由です。派手さはなくても、着実に前進し続けるその姿勢が、長い目で見たときに最も大きな結果をもたらします。あなたの細やかな配慮と献身的な努力が、周囲の人の成長を支え続けています。"},
  "庚":{t:["決断力","正義感","行動力"],d:"庚の人は研ぎ澄まされた刃のように鋭い決断力と正義感を持っています。白黒はっきりさせたい性格で、曖昧な状況を好まず常にクリアな方向性を求めます。強い行動力で目標に向かって突き進む力があり、困難な状況でもひるまない精神的な強さが持ち味です。ぶれない信念と素早い判断力が、周囲から頼りにされるリーダーシップにつながっています。正しいと思ったことを貫き通す強さが、時に孤高に見えることもありますが、その信念の強さこそがあなたの最大の魅力です。行動することを恐れない勇気が、道なき道を切り開いていきます。"},
  "辛":{t:["完璧主義","美意識","知性"],d:"辛の人は磨かれた宝石のように美しい知性と洗練された美意識を持っています。完璧主義な一面があり、細部にまでこだわる質の高さが仕事や創造活動における強みです。高い審美眼と知的な魅力で周囲を引きつけ、センスの良さと聡明さが自然と人を魅了します。理想を高く持ち続けることで自己成長を続け、周囲からの評価も自然と高まっていくでしょう。完璧を求めるがゆえに自分を追い込みすぎることもありますが、その真摯な姿勢が最終的に輝かしい結果をもたらします。あなたの洗練された感性と深い知性が、周囲に知的な刺激と美しさをもたらします。"},
  "壬":{t:["柔軟性","知恵","冒険心"],d:"壬の人は大海のように広大な懐と深い知恵を持っています。柔軟な思考力で状況に応じた最善策を見つけ出す能力があり、どんな困難も知恵で乗り越えていきます。冒険心旺盛で新しいことへのチャレンジを恐れないスケールの大きさが魅力です。固定観念にとらわれず自由な発想で物事を見る力が、周囲が思いつかないような革新的なアイデアを生み出す源になっています。大きな視野で物事を捉えることができるため、細かな問題に囚われることなく本質的な解決策を見出す力があります。あなたの知恵と柔軟性が、どんな状況でも最善の道を切り開いていきます。"},
  "癸":{t:["感受性","思いやり","忍耐力"],d:"癸の人は静かに大地を潤す雨のように深い感受性と豊かな思いやりを持っています。人の痛みを自分のことのように感じられる共感力の高さが最大の魅力であり、困っている人の心に自然と寄り添える稀有な存在です。忍耐強く困難な状況でも諦めずに前進する力があり、その粘り強さが最終的に大きな実りをもたらします。静かに積み重ねてきたものが、やがて大きな花を咲かせるでしょう。表には出ない深い感情の豊かさが、芸術や創造的な表現において唯一無二の作品を生み出す力となります。あなたの深い感受性と思いやりが、出会う人すべての心を静かに癒していきます。"}
};

var SSK={
  "子":{t:["知性","行動力","好奇心"],d:"子（ね）の人は頭の回転が速く、好奇心旺盛で何事にも積極的に取り組む活力があります。行動力があり新しいことへの挑戦を恐れない柔軟な精神が、次々と新しい可能性を切り開いていきます。知識を吸収するスピードが速く、様々な分野で幅広い才能を発揮します。頭の良さと行動力を兼ね備えた、バランスの取れた魅力的な人物です。変化に素早く適応できるため、時代の変化にも柔軟に対応し、新しい時代の波を上手に乗りこなすことができるでしょう。好奇心の赴くままに学び続けることが、あなたの可能性を無限に広げていきます。"},
  "丑":{t:["粘り強さ","誠実","堅実"],d:"丑（うし）の人は牛のように粘り強く誠実に物事を積み重ねる力を持っています。着実に一歩一歩進む堅実さが最大の強みであり、長期的な視野で努力を続けることで確かな成功を手にします。誠実さと信頼感が周囲から厚く評価され、時間をかけて築いた人間関係が人生の大きな財産になるでしょう。ゆっくりでも確実に前進することで、他の人が諦めてしまうような困難な目標も必ず達成することができます。その揺るぎない誠実さと責任感が、周囲から絶大な信頼を集め、重要な場面で頼りにされる存在となります。"},
  "寅":{t:["勇気","リーダーシップ","情熱"],d:"寅（とら）の人は虎のように勇気あふれるリーダーシップを持っています。情熱的に目標に向かって突き進む力があり、その行動力と決断力が周囲を自然と引っ張っていきます。困難な状況でも逃げずに立ち向かう勇気が、多くの人から尊敬を集める最大の魅力です。大きな夢を持ち、それを実現するための行動を惜しまない姿勢が輝いています。あなたの周りには自然と人が集まり、その情熱と行動力に触発されて周囲も奮い立つことができます。困難に正面から向き合う勇気こそが、あなたの人生を豊かに彩る最大の宝です。"},
  "卯":{t:["穏やか","社交性","センス"],d:"卯（う）の人は兎のように穏やかで社交的な魅力があります。優れた感性とセンスで周囲を和ませる天性の才能を持っており、自然と人が集まってくる温かな人柄が魅力です。争いを好まず調和を大切にする姿勢が、幅広い人間関係を築く力となります。繊細な感受性と柔らかな雰囲気が、多くの人から愛される理由です。その穏やかな存在感が、荒立った心を静め、周囲の人間関係を円滑にするバランサーとしての才能を持っています。センスの良さと優しさが織りなすあなたの個性が、多くの人の心に温かい印象を残すでしょう。"},
  "辰":{t:["カリスマ","向上心","独創性"],d:"辰（たつ）の人は龍のように天性のカリスマ性と強い向上心を持っています。独創的な発想と大胆な行動力で周囲を驚かせ、常に新しい価値を生み出していきます。高い目標を掲げ、それに向かって情熱的に突き進む姿が周囲に感動と刺激を与えます。スケールの大きな夢を描き、その実現に向けて力強く歩み続ける存在感が圧倒的な魅力です。あなたのカリスマ性と独創性が発揮されるとき、周囲の人々は自然と引き寄せられ、あなたの描くビジョンに共鳴していきます。大きな可能性を秘めた存在として、社会に革新をもたらす力を持っています。"},
  "巳":{t:["知恵","洞察力","粘り強さ"],d:"巳（み）の人は蛇のように深い知恵と鋭い洞察力を持っています。物事の本質を静かに見極める力があり、表面だけでなく深いところまで理解する知性が強みです。粘り強く目標を追い続ける忍耐力があり、諦めないことで最終的に必ず結果を手にします。慎重に状況を分析しながら最善のタイミングで動く判断力が、人生のあらゆる場面で活きてきます。表には出ないが内側に深い知識と洞察力を蓄えており、いざというときに全力を発揮する底力があります。その静かな強さと深い知恵が、長い時間をかけて磨かれることで、人生の大きな転機を掴む力となるでしょう。"},
  "午":{t:["明るさ","情熱","行動力"],d:"午（うま）の人は馬のように明るく情熱的なエネルギーが溢れています。素早い行動力と天性のポジティブさで周囲を活気づけ、その場の雰囲気を一変させる力があります。新しいことへの挑戦を楽しめる前向きな姿勢が、次々と新しいチャンスを引き寄せます。自由を愛し、広い世界に飛び出していく冒険心と行動力が人生を豊かに彩ります。どんな困難な状況でも明るさを失わないポジティブさが、周囲の人々に勇気と希望をもたらします。あなたの情熱と行動力が生み出す前進するエネルギーが、周囲を巻き込みながら大きな流れを作り出していきます。"},
  "未":{t:["温かさ","芸術性","協調性"],d:"未（ひつじ）の人は羊のように温かく芸術的な感性が豊かです。協調性があり周囲と調和しながら物事を進める力が、チームの中で重要な役割を果たします。美しいものへの感受性が高く、芸術や創造的な分野での才能を持っています。人の気持ちに寄り添える優しさと、場の空気を和ませる温かさが多くの人から愛される最大の魅力です。その繊細な感性と温かな人柄が、周囲の人たちの心を癒し、人間関係に豊かな彩りをもたらします。芸術的な才能を磨き続けることで、あなたにしか表現できない独自の世界観が広がっていくでしょう。"},
  "申":{t:["機転","多才","社交性"],d:"申（さる）の人は猿のように機転が利き多才で、高い社交性を持っています。様々な分野で才能を発揮できる柔軟性があり、新しい状況にも素早く適応する力が強みです。幅広い人脈を築く社交性と、その場に応じた機転の良さが、ビジネスでも私生活でも大きなアドバンテージになります。好奇心旺盛で常に学び続ける姿勢が、多才さをさらに磨いていくでしょう。その場の空気を素早く読み、最適な言葉や行動を選べる洗練されたコミュニケーション力が、あなたを社交の達人へと導きます。多彩な才能を活かして、様々な分野を横断しながら独自のポジションを確立していくことができます。"},
  "酉":{t:["完璧主義","美意識","誠実"],d:"酉（とり）の人は美意識が高く誠実さが際立つ完璧主義者です。細部にまでこだわる精緻さと、高い基準を持って物事に取り組む姿勢が周囲から高く評価されます。誠実な人柄と一度決めたことをやり遂げる責任感の強さが、長期的な信頼関係を築く力となります。美しいものや洗練されたものへの感性が鋭く、その審美眼が生活や仕事を豊かに彩ります。完璧を求める姿勢が時に自分や周囲へのプレッシャーになることもありますが、その高い基準こそが質の高い成果を生み出す源泉です。誠実さと美意識を兼ね備えたあなたの個性が、周囲に信頼と感動を与え続けます。"},
  "戌":{t:["忠実","正義感","誠実"],d:"戌（いぬ）の人は犬のように忠実で正義感が強く、誠実さが際立ちます。一度信頼を置いた人に対して揺るぎない誠実さで接し、その信頼に応え続ける責任感の強さが最大の魅力です。正しいことに対しては妥協しない強い正義感があり、その公平さと誠実さで周囲から深く頼りにされます。友情と人間関係を何よりも大切にする温かな心が、生涯の絆を育みます。あなたの誠実さと忠実さは、時代が変わっても変わることなく輝き続ける普遍的な美徳です。その正義感の強さが、不正や不公平に対して毅然と立ち向かう勇気となり、周囲の人々の信頼を集めます。"},
  "亥":{t:["粘り強さ","直感力","誠実"],d:"亥（い）の人は猪のように強い粘り強さと優れた直感力を持っています。一度決めたことを最後まで諦めない不屈の精神が、どんな困難も乗り越える力の源です。誠実な姿勢で人と向き合い、その真摯さが周囲から深い信頼を獲得します。鋭い直感力で物事の本質を捉える力があり、その判断を信じて行動することで正しい方向へ進むことができます。猪突猛進と見られることもありますが、その一途さと情熱こそが困難な目標を達成するために必要な力です。あなたの粘り強さと誠実さが積み重なって、やがて大きな信頼と実績という形で実を結んでいくでしょう。"}
};
