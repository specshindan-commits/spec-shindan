...
function scDiagnose(){
  ...
  setTimeout(function(){
    ...
    var jsHtml="<div class=\"sc-section\"><h3>✦ あなたの才能・魂の目的（"+mainJs+"） ✦</h3>"
      ...
      +"<p class=\"sc-desc\" style=\"margin-top:10px;font-weight:700;color:var(--primary);\">最良のパートナー像</p>"
      +"<p class=\"sc-desc\">"+jsData.partner+"</p></div>"
      +"<div class=\"sc-section\"><h3>✦ あなたの運気を高める重要人物 ✦</h3>"
      +"<p class=\"sc-desc\">"+jsData.support+"</p></div>"
